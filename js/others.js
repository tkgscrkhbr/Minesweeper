...
function specialfeel() {
    ...
    if (isSpecial) {
        ...
        sp.innerHTML = `<iframe width="1920" height="1080" src="https://www.youtube.com/embed/AZO5bcALdlE?autoplay=1&start=4&amp;end=20;" title="" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin">
